...
export const VEHICLE_WIDGET_VERSION = 'v40';
...
export function readMcpResource(uri: string) {
  ...
  const resources: Record<string, string> = {
    ...
    'ui://vehicle-results-v39.html': join(process.cwd(), 'src', 'ui', 'vehicle-results.html'),
    'ui://vehicle-results-v38.html': join(process.cwd(), 'src', 'ui', 'vehicle-results.html'),
    'ui://vehicle-results-v37.html': join(process.cwd(), 'src', 'ui', 'vehicle-results.html'),
    'ui://vehicle-results-v36.html': join(process.cwd(), 'src', 'ui', 'vehicle-results.html'),
